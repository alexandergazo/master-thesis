...
\begin{figure}[h!]
  ...
  \caption[Visualizations of properties of the collected dataset]{Visualizations of properties of the collected \CTK{} dataset. Figure adopted from \citet{ullrich}.}
  \label{fig:dashboard}
  \end{figure}
