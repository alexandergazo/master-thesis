...
The negation used has to be non-trivial, because simple negative words and phrases like "no" and "it is not true, that" can be levereged by the later steps of the fact-checking pipeline to immeadetely classify claims as Refuted instead of trying to really understand the text.
...
For use in baseline training and pre-training we localized the original FEVER dataset into Czech language. 
...
Because of the large-scale usage of machine translation without the means for robust evaluation, and the lack of one-to-one correspondence between Czech and English Wikipedia articles, this dataset serves only as a baseline to verify robustness of our models on a larger scale, primarly for the document retrieval part of the pipeline.
...
%{"id": 153304, "verifiable": "VERIFIABLE", "label": "REFUTES", "claim": "Ilkhanate byl založen jako pohár.", "evidence": [[[177249, 190108, "Ílchanát", 0, "Ilkhanate"]]], "claim_en": "Ilkhanate was established as a cup."}
%{"id": 120449, "verifiable": "VERIFIABLE", "label": "SUPPORTS", "claim": "Venuše se nazývá „sesterskou planetou“ Země.", "evidence": [[[141476, 156671, "Venuše (planeta)", 8, "Venus"]]], "claim_en": "Venus is called the \"sister planet\" of Earth."}

\section{\CTK}
% nomenclature

The basis for this dataset is the collection of Czech news articles provided in colaboration with Czech News Agency\footnote{Česká Tlačová Agentúra (ČTK)}. 
